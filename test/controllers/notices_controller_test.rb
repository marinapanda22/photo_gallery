...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body: @notice.body, gallery_id: @notice.gallery_id, mark: @notice.mark, user_id: @notice.user_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body: @notice.body, gallery_id: @notice.gallery_id, mark: @notice.mark, user_id: @notice.user_id } }
